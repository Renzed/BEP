...
if __name__ == '__main__':
    ...
    edgerange = np.linspace(0, 1, msims)
    ...
    for edges in edgerange:
        ...
        network = networkx.watts_strogatz_graph(nosc, 2, edges)
        ...
        for k in range(averageingnum):
            ...
            eigen_freqs = np.random.normal(0, noise_range, (nosc, nsims)).transpose()
            ...
            args = [tuple(list(subargs[i])+[noise_range[i], matrix]) for i in range(nsims)]
